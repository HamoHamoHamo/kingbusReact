...
export default function Estimate() {
    ...
    const surcharge = () => {
        ...
        const SurchargeCellSvg = document.querySelectorAll(".SurchargeCell svg");
        const previweSurchargeCell = document.querySelectorAll(".previweSurchargeCell");

        for (let i = 0; i < 5; i++) {
            SurchargeCell[i].addEventListener("click", clickToSurcharge)
        }
        function clickToSurcharge() {
            if (this.classList.contains("changeColor")) {
                for (let i = 0; i < 5; i++) {
                    if (this.id == i) {
                        SurchargeCell[i].querySelector(".SurchargeCell svg path").style.fill = "#b00020"
                        SurchargeCell[i].querySelector(".SurchargeCell span").style.color = "#b00020"
                        SurchargeCell[i].classList.remove("changeColor")
                        SurchargeCell[i + 5].classList.remove("displayNone")
                    }
                }
            } else {
                for (let i = 0; i < 5; i++) {
                    if (this.id == i) {
                        SurchargeCell[i].querySelector(".SurchargeCell svg path").style.fill = "#7F7F7F"
                        SurchargeCell[i].querySelector(".SurchargeCell span").style.color = "#7F7F7F"
                        SurchargeCell[i].classList.add("changeColor")
                        SurchargeCell[i + 5].classList.add("displayNone")
                    }
                }
            }
        }
            ...
            <div class="topOrder" style={{ height: "auto" }}>
                ...
                <div class="topOrderMoreInfor displayNone">
                    ...
                    <div class="topOrderMoreInforBox">
                        ...
                        <textarea class="additionalRequestCell" placeholder="추가요청사항"></textarea>
                    </div>
                </div>
                                ...
                                <div class="additionalFeeInputCell estimateInputCell">
                                    ...
                                    <div class="surchargeContainer">
                                        <div class="SurchargeBox">
                                            <div class="SurchargeCell changeColor" id="0">
                                            ...
                                            <div class="SurchargeCell changeColor" id="1">
                                            ...
                                            <div class="SurchargeCell changeColor" id="2">
                                            ...
                                            <div class="SurchargeCell changeColor" id="3">
                                            ...
                                            <div class="SurchargeCell changeColor" id="4">
